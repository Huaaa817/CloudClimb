...
set_property PACKAGE_PIN E19 [get_ports {pass2}]
set_property IOSTANDARD LVCMOS33 [get_ports {pass2}]
set_property PACKAGE_PIN U19 [get_ports {pass3}]
set_property IOSTANDARD LVCMOS33 [get_ports {pass3}]
set_property PACKAGE_PIN V19 [get_ports {pass4}]
set_property IOSTANDARD LVCMOS33 [get_ports {pass4}]
...
## Pmod Header JA
# # Sch name = JA1
# set_property PACKAGE_PIN J1 [get_ports {KEY_RIGHT_MASTER}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {KEY_RIGHT_MASTER}]
# # Sch name = JA2
# set_property PACKAGE_PIN L2 [get_ports {KEY_LEFT_MASTER}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {KEY_LEFT_MASTER}]
# # Sch name = JA3
# set_property PACKAGE_PIN J2 [get_ports {KEY_RIGHT}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {KEY_RIGHT}]
# # Sch name = JA4
# set_property PACKAGE_PIN G2 [get_ports {KEY_LEFT}]
...
## Pmod Header JB
# Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {KEY_RIGHT_MASTER}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_RIGHT_MASTER}]
# Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {KEY_LEFT_MASTER}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_LEFT_MASTER}]
# Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {KEY_RIGHT}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_RIGHT}]
# Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {KEY_LEFT}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_LEFT}]
# Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {state_valid}]
   set_property IOSTANDARD LVCMOS33 [get_ports {state_valid}]
## Sch name = JB8
