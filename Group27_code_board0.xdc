...
# Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {KEY_RIGHT_SLAVE}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_RIGHT_SLAVE}]
# Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {KEY_LEFT_SLAVE}]
   set_property IOSTANDARD LVCMOS33 [get_ports {KEY_LEFT_SLAVE}]
# Sch name = JB7
